...
root=Tk()
root.geometry("1800x8000")
root.title("Restaurant Management System BY mr SAHIL")
...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="pinnovation RESTAURANT",fg="Steel Blue",bd=10,anchor='w')
...
lblReference= Label(f1, font=('arial', 16, 'bold'),text="Reference",bd=16,anchor="ne")
