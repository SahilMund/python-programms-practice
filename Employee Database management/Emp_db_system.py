...
#============================BUTTONS=====================================
btn_add = Button(MidLeft, text="ADD NEW EMP DATA", bg="lime", command=AddNewWindow)
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="cyan", command=DeleteData)
