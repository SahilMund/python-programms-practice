...
def emp():
    windows.destroy()
    emlg.emplg()
img=PhotoImage(file = r"E:/factory ms/emp.png")
img1=img.subsample(3,3)
img2=PhotoImage(file = r"E:/factory ms/adm.png")
...
def m2():
    ...
    tk.mainloop()
img30=PhotoImage(file = r"E:/factory ms/about.png")
...
def m3():
    ...
    sk.mainloop()
img26=PhotoImage(file = r"E:/factory ms/contact.png")
img27=img26.subsample(3,3)
btna=Button(windows,image=img27,command=m3)
btna.place(x=1250,y=100)
img20=PhotoImage(file = r"E:/factory ms/fb.png")
img21=img20.subsample(3,3)
img22=PhotoImage(file = r"E:/factory ms/insta.png")
img23=img22.subsample(3,3)
img24=PhotoImage(file = r"E:/factory ms/youtube.png")
